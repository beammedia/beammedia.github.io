...
function scroll() {
  ...
  $(window).scroll(function() { 
    ...
    if (scroll > 0) {
      ...
      $("#to-top").removeClass("animated fadeOut").addClass("animated fadeIn");
    } else {
      $("#header").removeClass("sticky");
      $("#to-top").removeClass("animated fadeIn").addClass("animated fadeOut");
    }
...
function inview() {
  ...
  $('.section .heading').on('inview', function(event, isInView, visiblePartX, visiblePartY) {
    $(this).queue(function() {$(this).addClass("animated fadeInUp");});
  });
  
  $('.section .content').on('inview', function(event, isInView, visiblePartX, visiblePartY) {
    $(this).delay(250).queue(function() {$(this).addClass("animated fadeInUp");});
  });
  
  $('.list .item').on('inview', function(event, isInView, visiblePartX, visiblePartY) {
    $(this).delay(250).queue(function() {$(this).addClass("animated fadeInUp");});
  });
...
$(document).ready(function(){
  ...
  $share.on('click', 'a', function() {
      var shareType = $(this).attr('class'),
          ...
          twitterLink = 'http://twitter.com/home/?status=' + pageUrl,
          languageLink = this.href,
          openFrame = '_blank';
      ...
      switch (shareType) {
          ...
          case ('twitter'):
              ...
              break;
          case ('language'):
              window.open(languageLink, '_self');
              break;
          default:
              return false;
      }
